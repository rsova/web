...
//	@Before
	...
	public void test_condo() throws Exception{
		...
		//curl
		curl.add("-d " + XmlRpcHelper.toXmlRpcRequest(METHOD,['dbid':'dbid1139259934','getlist':'condo']))
	...
	public void test_district() throws Exception{
		...
		def test = getName().replaceFirst('test_','')
		//curl
		curl.add("-d " + XmlRpcHelper.toXmlRpcRequest(METHOD,['dbid':'dbid1139259934','getlist':'district']))
	...
	public void test_agent() throws Exception{
		def test = getName().replaceFirst('test_','')
		//curl
		curl.add("-d " + XmlRpcHelper.toXmlRpcRequest(METHOD,['dbid':'dbid1139259934','getlist':'agent']))	
	...
	public void testOffice() throws Exception{
		def test = getName().replaceFirst('test_','')
		//curl
		curl.add("-d " + XmlRpcHelper.toXmlRpcRequest(METHOD,['dbid':'dbid1139259934','getlist':'office']))		
