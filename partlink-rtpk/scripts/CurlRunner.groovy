...
//https://www.logisticsinformationservice.dla.mil/webflis/pub/pub_search.aspx?niin=015127231
def NIIN = '015127231'
def process = ['curl', "http://www.logisticsinformationservice.dla.mil/webflis/pub/pub_search.aspx?niin=$NIIN"].execute()
def html = process.text
println html
